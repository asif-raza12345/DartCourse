void main(List<String> args) {
  ...
  print(integerNumber.isInfinite);
  print(integerNumber.isFinite);

  // 7. integerNumber.runtimeType
  // Explanation: return the type

  print(integerNumber.runtimeType); // Output: int
}
