void main(List<String> args) {
  ...
  greetUser("Mannan", age: 30); // Overrides the default age
  ...
  void greetPerson(String name,
      {String greeting = 'Hello', String suffix = '!'}) {
    print('$greeting, $name$suffix');
  }

  greetPerson('Arslan'); // Output: Hello, Arslan!
  greetPerson('Hannan', greeting: 'Hi'); // Output: Hi, Adnan!
  greetPerson('Mannan', suffix: '!!'); // Output: Hello, Ibraheem!!
}
