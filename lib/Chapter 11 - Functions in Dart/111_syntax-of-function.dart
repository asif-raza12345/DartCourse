void main(List<String> args) {
  ...
  // return_type function_name (parameter1, parameter 2, ....){
  //   // function body
  //   // code to be executed
  ...
  5. Return Statement (optional): If the function has a return type other than void, you can use the return statement to specify the value to be returned from the function. The return statement ends the function's execution and sends the result back to the caller.
