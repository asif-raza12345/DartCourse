void main(List<String> args) {
  ...
  ages.forEach((key, value) {
    if (key == 'Hannan') {
      print('Hannan\'s age: $value'); // Output: Bob's age: 20
    }
  });
  ...
  ages['Mannan'] = 21; // Modifying Bob's age
  ...
  ages['Hannan'] = 4; // Adding a new key-value pair
  print('Updated ages: $ages');
  ...
  ages.remove('Rizwan'); // Removing the 'Ali' key-value pair
  print('Updated ages: $ages');

  // 2: Using removeWhere method

  ages.removeWhere(
      (key, value) => key == 'Arslan'); // Removing the 'Arslan' key-value pair
  print('Updated ages: $ages');
