void main(List<String> args) {
  ...
  unmodifiableMap['apple'] =
      5; // Throws an exception: Unsupported operation: Cannot modify an unmodifiable map

  unmodifiableMap.remove(
      'banana'); // Throws an exception: Unsupported operation: Cannot modify an unmodifiable map
