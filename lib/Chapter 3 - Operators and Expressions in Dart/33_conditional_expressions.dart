void main(List<String> args) {
  ...
  */
  ...
  var admission = marks >= 50 && entryTest == "pass"
      ? "you're eligible for admission"
      : "Sorry you're not eligible for admission";
  print(admission);
  ...
  var drivingLicense = personAge >= 18 && personAge <= 60
      ? "You're eligible for driving license"
      : "Sorry you're not eligible for driving license";
