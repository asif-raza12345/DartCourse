void main() {
  ...
  print("""My Name is Arslan and i am learning 
dart language. Todays topic is String. 
String is very powerful feature of dafrt language""");

  var multiString =
      ''' A multiline string, also known as a multiline text or a block of text, refers to a string that spans multiple lines of code. In Dart, multiline strings are created using triple quotes. ''';
