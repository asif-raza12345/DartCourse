void main(List<String> args) {
  ...
  */
  ...
  String name = 'Arslan Tariq'; // Using single quotes
  String message = "Hello, Dart!"; // Using double quotes
  String quote = 'He said, "I love Programming!"'; // Using quotes within quotes

  // You can also print these string variables
  ...
  print("name variable length is ${name.length}");
  print("message variable length is ${message.length}");
  print("quote variable length is ${quote.length}");
}
